...
const Home = () => {
  return (
    <div className='flex flex-col justify-center items-center mt-10' >
      <h1 className='text-8xl'>Vi gifter oss!</h1>
      <img src={Alexognina} alt="img" className='mt-8 h-56' />
      <h2 className='w-96 text-center mt-5 text-xl'>Det er til stor glede for oss om akkurat <span className='border-b border-black'>DU</span> vil feire dagen sammen med oss 29. juni!</h2>
