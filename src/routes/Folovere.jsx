        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-10 mt-10'>
            ...
            <div className='flex flex-col items-center'>
                ...
                <p className='navfont mt-10 text-xl text-center max-w-xs'>
                    ...
                    Vi har delt gleder og sorger og mang en vinflaske gjennom årene. Kristin
                    er en strålende dame med en smittende latter og et upåklagelig humør. Hun
                    er kunnskaprik, klok og med stor sans for orning och reda. Kristin
                    elsker å reise til fjerne strøk og bringer hvert år med seg innsikt og
                    gode historier hjem til meg - som ofte har brukt tiden på å rusle rundt
                    på tunet i Heidal.
                </p>
            </div>
            ...
            <div className='flex flex-col items-center'>
                ...
                <p className='navfont mt-10 text-xl text-center max-w-xs'>
                    Emil, Henning og jeg (Alex) ble gode venner etter videregående, ved å henge i samme leilighet i
                    Lillestrøm. Vi startet å studere sammen, trene sammen, bokse sammen, dro til USA sammen, var
                    faddere sammen, og startet å jobbe sammen. Emil og Henning er to uvurderlige venner jeg ikke
                    klarte å velge mellom, så det måtte bli begge som forlovere, så klart!
                    Emil er smart, snill og reflektert, alltid klar for en dyp samtale eller en utfordrende
                    sjakkmatch. Han bringer alltid en god stemning og sitt varme hjerte inn i enhver situasjon.
                    Henning er trygg, pålitelig og lojal, en klippe i livet og en man kan stole på. Hans stabilitet
                    og gode råd har vært uvurderlig gjennom årene.
                </p>
            </div>
        </div>
    </div>);
