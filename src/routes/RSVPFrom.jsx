...
const RSVPForm = () => {
  return (
    <div className='flex flex-col mt-20 p-5 justify-center bg-stone-700 items-center bg-cover text-white h-96 shadow-2xl'>
      ...
      <p className='navfont text-xl'>Vi gleder oss!</p>
      </div>
    </div>
  );
};
