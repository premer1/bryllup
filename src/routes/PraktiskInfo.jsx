...
const PraktiskInfo = () => {
  return (
    <div className='flex flex-col items-center justify-center mt-10'>
      ...
      <div className='flex flex-col justify-center items-center mt-4 text-center text-2xl'>
      ...
      <h2 className='mt-10 text-center text-xl'>Lurt å ta med jakke <br />For Tøffinger - Ta med badetøy og håndkle</h2>
